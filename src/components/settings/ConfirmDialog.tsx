 ...
 *
 *  Backdrop-click cancels as a convenience, but only on a genuine backdrop
 *  press (both mousedown and mouseup on the overlay). A selection drag that
 *  starts on the message and releases outside will NOT dismiss it. */
