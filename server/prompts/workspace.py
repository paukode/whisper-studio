...
def workspace_prompt(ws_path: str, session_id: str = "default") -> str:
    ...
    return (
        ...
        "\n\nENVIRONMENTS: This is the user's machine, not an environment you own. Other "
        "projects' interpreters and virtualenvs are off limits, and hunting through the "
        "filesystem for Python installations or installed packages is not allowed. Python "
        "work goes through run_python (this app's interpreter, which already carries its "
        "data and Office libraries) and Word, Excel or PowerPoint work through office_script. "
        "When a shell task needs a package the system python3 lacks, make a throwaway "
        "virtualenv in the workspace or the scratch directory and install there."
