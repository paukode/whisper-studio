...
WSDiagram.mount("goals-tut-diagram", {
  ...
  nodes: [
    ...
    { id: "gate", group: "security", col: 2, row: 1, label: "completion gate", sub: "achieved?", desc: "At the end of each turn the gate runs Stop hooks and a cheap evaluator (and weighs a VERIFY PASS/FAIL from the built-in verify_change tool). If the goal is not met, it feeds back what's missing and the turn continues." },
