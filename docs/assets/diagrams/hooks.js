...
WSDiagram.mount("hooks-diagram", {
  ...
  nodes: [
    { id: "executor", group: "server", col: 0, row: 1, label: "Tool executor", sub: "execute_tool_batch", desc: "Before running a tool, the executor calls the hooks engine for PreToolUse; after, for PostToolUse. Sub-agents, cron runs, and headless turns share this same executor." },
