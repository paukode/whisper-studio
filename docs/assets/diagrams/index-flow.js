...
WSDiagram.mount("index-flow-diagram", {
  ...
  nodes: [
    ...
    { id: "graph", group: "index", col: 0, row: 1, label: "Entity graph", sub: "GLiNER / Haiku", desc: "Named entities are extracted per chunk and deduped into canonical nodes. Files and entities that co-occur become linked, browsable in the index explorer." },
    ...
    { id: "retr", group: "index", col: 2, row: 1, label: "Retrieve passages", sub: "vector + keyword", desc: "Vector search finds the closest chunks, an optional reranker (off by default) reorders them, and one GraphRAG hop pulls in passages linked through shared entities." },
