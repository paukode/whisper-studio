...
WSDiagram.mount("ultracode-diagram", {
  ...
  nodes: [
    ...
    { id: "preview", group: "browser", col: 2, row: 0, label: "Approval preview", sub: "phases + full script", desc: "WorkflowPreviewCard shows the phases as a stepper, the whole script, and the output-token budget. Upfront human approval of every new script is the PRIMARY trust anchor for the vm. Approving POSTs to the launch route; an 'Always allow this workflow' checkbox saves the script as trusted so future runs by name skip the card." },
