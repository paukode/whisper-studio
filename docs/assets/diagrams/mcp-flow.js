...
WSDiagram.mount("mcp-flow-diagram", {
  ...
  nodes: [
    ...
    { id: "enable", group: "server", col: 1, row: 0.5, label: "Enable", sub: "MCP opt-out, plugins opt-in", desc: "Adding an MCP server enables and starts it immediately (a per-server enabled flag in Settings > MCP, on by default, persists across turns); a plugin instead does nothing until you enable it in Settings, and most take effect live, no restart." },
