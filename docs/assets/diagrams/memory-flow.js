...
WSDiagram.mount("memory-flow-diagram", {
  ...
  nodes: [
    ...
    { id: "extract", group: "server", col: 1, row: 0, label: "Post-turn review", sub: "every few turns", desc: "A background review replays the turn you just had and asks what is worth remembering, saving durable facts as memories and repeatable procedures as skills. A separate summarizer keeps the session summary up to date. Neither blocks your chat." },
