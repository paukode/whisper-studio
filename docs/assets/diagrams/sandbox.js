...
WSDiagram.mount("sandbox-diagram", {
  ...
  nodes: [
    ...
    { id: "appr", group: "security", col: 2, row: 0, label: "Approval", sub: "server-side pause", desc: "Risky commands pause the turn in paused_sessions; nothing runs until the client explicitly posts the action to /api/approval/execute. A real consent boundary." },
