...
WSDiagram.mount("first-chat-diagram", {
  ...
  nodes: [
    ...
    { id: "model", group: "external", kind: "external", col: 3, row: 0, label: "Selected model", sub: "Bedrock or local", desc: "Claude or GPT-5.x on Amazon Bedrock, or an on-device model in local mode - whichever you picked - streams its answer back token by token." },
